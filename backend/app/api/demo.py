...
DEMO_SAMPLES = {
    "viator_04": {
        "id": "viator_04",
        "title": "Viator-04 (Held-out Test Shipwreck â€” True Positive)",
    ...
    "artificial_reef_02": {
        ...
        "title": "Artificial Reef-02 (Held-out Test Clutter â€” Operator Triage Demo)",
    ...
    "corsican_02": {
        "id": "corsican_02",
        "title": "Corsican-02 (Held-out Test Shipwreck â€” Verified Anomaly)",
...
def load_demo_sample(sample_id: str, db: Session = Depends(get_db)):
    ...
    logger.info("Demo sample '%s' loaded as survey '%s' with %d contacts.", sample_id, survey_id, len(contacts))
